    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F5E1D3] bg-opacity-80">
      ...
      <Card className="w-full max-w-md bg-white bg-opacity-90 shadow-lg relative z-10">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl font-bold text-center text-[#4A3728]">Welcome back, coffee lover!</CardTitle>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="justify-center">
          <p className="text-[#4A3728]">
            ...
            <Link href="/auth/register" className="text-[#8B4513] hover:underline font-semibold">
              Register here
            </Link>
          </p>
        </CardFooter>
